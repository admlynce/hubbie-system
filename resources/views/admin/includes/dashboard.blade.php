...
<head>
    ...
    <link rel="apple-touch-icon" href="{{asset('/private/app-assets/images/ico/apple-icon-120.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('/private/app-assets/images/ico/favicon.ico')}}">
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,300;0,400;0,500;0,600;1,400;1,500;1,600"
          rel="stylesheet">

    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('/private/app-assets/vendors/css/vendors.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/private/app-assets/vendors/css/charts/apexcharts.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('/private/app-assets/vendors/css/extensions/toastr.min.css')}}">
    <!-- END: Vendor CSS-->

    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('/private/app-assets/vendors/css/vendors.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/private/app-assets/vendors/css/tables/datatable/dataTables.bootstrap5.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/private/app-assets/vendors/css/tables/datatable/extensions/dataTables.checkboxes.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/private/app-assets/vendors/css/tables/datatable/responsive.bootstrap5.min.css')}}">
    <!-- END: Vendor CSS-->


    <!-- BEGIN: Theme CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('/private/app-assets/css/bootstrap.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/private/app-assets/css/bootstrap-extended.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/private/app-assets/css/colors.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/private/app-assets/css/components.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/private/app-assets/css/themes/dark-layout.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/private/app-assets/css/themes/bordered-layout.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/private/app-assets/css/themes/semi-dark-layout.css')}}">

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css"
          href="{{asset('/private/app-assets/css/core/menu/menu-types/vertical-menu.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/private/app-assets/css/pages/dashboard-ecommerce.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('/private/app-assets/css/plugins/charts/chart-apex.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('/private/app-assets/css/plugins/extensions/ext-component-toastr.css')}}">
    <!-- END: Page CSS-->

    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('/private/assets/css/style.css')}}">
    <!-- END: Custom CSS-->
...
<ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            ...
            <div class="d-flex">
                <div class="me-75"><img src="{{asset('/private/app-assets/images/icons/xls.png')}}" alt="png"
                                        height="32"></div>
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                                   href="app-file-manager.html">
            <div class="d-flex">
                <div class="me-75"><img src="{{asset('/private/app-assets/images/icons/jpg.png')}}" alt="png"
                                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                                   href="app-file-manager.html">
            <div class="d-flex">
                <div class="me-75"><img src="{{asset('/private/app-assets/images/icons/pdf.png')}}" alt="png"
                                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                                   href="app-file-manager.html">
            <div class="d-flex">
                <div class="me-75"><img src="{{asset('/private/app-assets/images/icons/doc.png')}}" alt="png"
                                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
            ...
            <div class="d-flex align-items-center">
                <div class="avatar me-75"><img
                        src="{{asset('/private/app-assets/images/portrait/small/avatar-s-8.jpg')}}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
            ...
            <div class="d-flex align-items-center">
                <div class="avatar me-75"><img
                        src="{{asset('/private/app-assets/images/portrait/small/avatar-s-1.jpg')}}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
            ...
            <div class="d-flex align-items-center">
                <div class="avatar me-75"><img
                        src="{{asset('/private/app-assets/images/portrait/small/avatar-s-14.jpg')}}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
            ...
            <div class="d-flex align-items-center">
                <div class="avatar me-75"><img
                        src="{{asset('/private/app-assets/images/portrait/small/avatar-s-6.jpg')}}" alt="png"
                        height="32"></div>
                <div class="search-data">
...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a class="d-flex align-items-center" href="app-email.html"><i data-feather="home"></i><span
            ...
            <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="file-text"></i><span
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="d-flex align-items-center" href="app-invoice-preview.html"><i
                                data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Listar">Listar</span></a>
                    </li>
                </ul>
            </li>
...
{{--                                <img src="{{asset('/private/app-assets/images/illustration/badge.svg')}}"--}}
...
{{--                                                        <div class="avatar-content">--}}
{{--                                                            <img--}}
{{--                                                                src="{{asset('/private/app-assets/images/icons/toolbox.svg')}}"--}}
{{--                                                                alt="Toolbar svg"/>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                    <div>--}}
...
{{--                                                        <div class="avatar-content">--}}
{{--                                                            <img--}}
{{--                                                                src="{{asset('/private/app-assets/images/icons/parachute.svg')}}"--}}
{{--                                                                alt="Parachute svg"/>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                    <div>--}}
...
{{--                                                        <div class="avatar-content">--}}
{{--                                                            <img--}}
{{--                                                                src="{{asset('/private/app-assets/images/icons/brush.svg')}}"--}}
{{--                                                                alt="Brush svg"/>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                    <div>--}}
...
{{--                                                        <div class="avatar-content">--}}
{{--                                                            <img--}}
{{--                                                                src="{{asset('/private/app-assets/images/icons/star.svg')}}"--}}
{{--                                                                alt="Star svg"/>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                    <div>--}}
...
{{--                                                        <div class="avatar-content">--}}
{{--                                                            <img--}}
{{--                                                                src="{{asset('/private/app-assets/images/icons/book.svg')}}"--}}
{{--                                                                alt="Book svg"/>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                    <div>--}}
...
{{--                                                        <div class="avatar-content">--}}
{{--                                                            <img--}}
{{--                                                                src="{{asset('/private/app-assets/images/icons/rocket.svg')}}"--}}
{{--                                                                alt="Rocket svg"/>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                    <div>--}}
...
{{--                                                        <div class="avatar-content">--}}
{{--                                                            <img--}}
{{--                                                                src="{{asset('/private/app-assets/images/icons/speaker.svg')}}"--}}
{{--                                                                alt="Speaker svg"/>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                    <div>--}}
...
{{--                                <img src="{{asset('/private/app-assets/images/illustration/email.svg')}}"--}}
...
{{--                                        <img src="{{asset('/private/app-assets/images/portrait/small/avatar-s-9.jpg')}}"--}}
{{--                                             alt="Avatar" width="33" height="33"/>--}}
{{--                                    </div>--}}
{{--                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom"--}}
{{--                                         title="Amy Carson" class="avatar pull-up">--}}
{{--                                        <img src="{{asset('/private/app-assets/images/portrait/small/avatar-s-6.jpg')}}"--}}
{{--                                             alt="Avatar" width="33" height="33"/>--}}
{{--                                    </div>--}}
{{--                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom"--}}
{{--                                         title="Brandon Miles" class="avatar pull-up">--}}
{{--                                        <img src="{{asset('/private/app-assets/images/portrait/small/avatar-s-8.jpg')}}"--}}
{{--                                             alt="Avatar" width="33" height="33"/>--}}
{{--                                    </div>--}}
{{--                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom"--}}
{{--                                         title="Daisy Weber" class="avatar pull-up">--}}
{{--                                        <img--}}
{{--                                            src="{{asset('/private/app-assets/images/portrait/small/avatar-s-20.jpg')}}"--}}
{{--                                            alt="Avatar" width="33" height="33"/>--}}
{{--                                    </div>--}}
{{--                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom"--}}
...
{{--                                    <div class="d-flex">--}}
{{--                                        <img src="{{asset('/private/app-assets/images/icons/google-chrome.png')}}"--}}
...
{{--                                <div class="browser-states">--}}
{{--                                    <div class="d-flex">--}}
{{--                                        <img src="{{asset('/private/app-assets/images/icons/mozila-firefox.png')}}"--}}
...
{{--                                <div class="browser-states">--}}
{{--                                    <div class="d-flex">--}}
{{--                                        <img src="{{asset('/private/app-assets/images/icons/apple-safari.png')}}"--}}
...
{{--                                <div class="browser-states">--}}
{{--                                    <div class="d-flex">--}}
{{--                                        <img src="{{asset('/private/app-assets/images/icons/internet-explorer.png')}}"--}}
...
{{--                                <div class="browser-states">--}}
{{--                                    <div class="d-flex">--}}
{{--                                        <img src="{{asset('/private/app-assets/images/icons/opera.png')}}"--}}
