...
<head>
    <meta charset="utf-8">
    <title>Finder | City Guide | Home v1</title>
    <!-- SEO Meta Tags-->
    ...
    <link rel="icon" type="{{asset('site/image/png')}}" sizes="32x32" href="favicon-32x32.png')}}">
    <link rel="icon" typ="{{asset('site/image/png')}}" sizes="16x16" href="favicon-16x16.png')}}">
    ...
    <!-- Vendor Styles-->
    <link rel="stylesheet" media="screen" href="{{asset('site/vendor/simplebar/dist/simplebar.min.css')}}"/>
    <link rel="stylesheet" media="screen" href="{{asset('site/vendor/tiny-slider/dist/tiny-slider.css')}}"/>
                ...
                <div class="modal-body px-0 py-2 py-sm-0">
                    ...
                    <div class="row mx-0 align-items-center">
                        <div class="col-md-6 border-end-md p-4 p-sm-5">
                            <h2 class="h3 mb-4 mb-sm-5">Eei !<br>Bem vindo de volta.</h2><img class="d-block mx-auto"
                                                                                              src="{{asset('site/img/signin-modal/signin.svg')}}"
                                                                                              width="344"
                                                                                              alt="Illustartion">
                            <div class="mt-4 mt-sm-5">Não tem uma conta? <a href="#signup-modal" data-bs-toggle="modal"
                        ...
                        <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                            <form class="needs-validation" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" type="email" id="signin-email" name="email"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="password-toggle">
                                        ...
                                        <label class="password-toggle-btn" aria-label="Mostrar/esconder senha">
...
<!-- Sign Up Modal-->
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered p-2 my-0 mx-auto" style="max-width: 950px;">
            <div class="modal-content">
                <div class="modal-body px-0 py-2 py-sm-0">
                    ...
                    <div class="row mx-0 align-items-center">
                        <div class="col-md-6 border-end-md p-4 p-sm-5">
                            <h2 class="h3 mb-4 mb-sm-5">Cadastre no Hubbie.<br>Receba alguns benefícios:</h2>
                            <ul class="list-unstyled mb-4 mb-sm-5">
                                <li class="d-flex mb-2"><i class="fi-check-circle text-primary mt-1 me-2"></i><span>Promover sua empresa</span>
                                </li>
                                <li class="d-flex mb-2"><i class="fi-check-circle text-primary mt-1 me-2"></i><span>Ganhe descontos nos lugares</span>
                                </li>
                                <li class="d-flex mb-2"><i class="fi-check-circle text-primary mt-1 me-2"></i><span>Ganhe moedas para trocar por premio</span>
                                </li>
                                <li class="d-flex mb-0"><i class="fi-check-circle text-primary mt-1 me-2"></i><span>Ganhe dinheiro indicando</span>
                                </li>
                            </ul>
                            <img class="d-block mx-auto" src="{{asset('site/img/signin-modal/signup.svg')}}" width="344"
                                 alt="Illustartion">
                        </div>
                        <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                            @if ($errors->any())
                            ...
                            <form class="needs-validation" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="mb-4">
                                    <label class="form-label" for="signup-password-confirm">Confirmar senha</label>
                                    <div class="password-toggle">
                                ...
                                <div class="form-check mb-4">
                                    ...
                                    <label class="form-check-label" for="agree-to-terms">
                                        Ao aderir, concordo com os <a
                                            href='#'>termos de uso</a> e <a href='#'>política de privacidade</a></label>
                                </div>
                                <button class="btn btn-primary btn-lg rounded-pill w-100" type="submit">Cadastrar
                                </button>
                            </form>
                        </div>
                    </div>
    ...
    <header class="navbar navbar-expand-lg navbar-light fixed-top" data-scroll-header>
        <div class="container"><a class="navbar-brand me-3 me-xl-4" href="city-guide-home-v1.html"><img class="d-block"
                                                                                                        src="{{asset('site/img/logo/logo-dark.svg')}}"
                                                                                                        width="116"
                                                                                                        alt="Finder"></a>
            ...
            <a class="btn btn-primary btn-sm rounded-pill ms-2 order-lg-3" href="#signup-modal" data-bs-toggle="modal">
                <i class="fi-plus me-2"></i>Cadastrar
            </a>
            <div class="collapse navbar-collapse order-lg-2" id="navbarNav">
                <ul class="navbar-nav navbar-nav-scroll" style="max-height: 35rem;">
                    <!-- Menu items-->
                    <li class="nav-item dropdown active"><a class="nav-link dropdown-toggle" href="#" role="button"
                                                            data-bs-toggle="dropdown" aria-expanded="false">Página
                            Inicial</a>
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="city-guide-single-reviews.html">Single Place -
                                    Reviews</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="city-guide-account-notifications.html">Notifications</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="city-guide-business-promotion.html">Business
                                    Promotion</a></li>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown"><a class="dropdown-item dropdown-toggle" href="#" role="button"
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="city-guide-help-center-single-topic.html">Single
                                            Topic</a></li>
                                </ul>
                            </li>
    ...
    <section class="container py-5 mt-5 mb-lg-3">
        <div class="row align-items-center mt-md-2">
            <div class="col-lg-7 order-lg-2 mb-lg-0 mb-4 pb-2 pb-lg-0"><img class="d-block mx-auto"
                                                                            src="{{asset('site/img/city-guide/home/hero-img.jpg')}}"
                                                                            width="746" alt="Hero image"></div>
            <div class="col-lg-5 order-lg-1 pe-lg-0">
                <h1 class="display-5 mb-4 me-lg-n5 text-lg-start text-center mb-4">Começar a explorar <span
                        class="dropdown d-inline-block"><a class="dropdown-toggle text-decoration-none" href="#"
                            ...
                            class="dropdown-menu dropdown-menu-end my-1"><a class="dropdown-item fs-base fw-bold"
                                                                            href="#">Santa Terezinha</a><a
                                class="dropdown-item fs-base fw-bold" href="#">Cascavel</a></span></span></h1>
                <p class="text-lg-start text-center mb-4 mb-lg-5 fs-lg">Encontre ótimos lugares para ficar, comer, fazer
                    compras ou visitar nossos parceiros e especialistas locais.</p>
                <!-- Search form-->
                <div class="me-lg-n5">
                        ...
                        <div class="d-sm-flex">
                            <div class="dropdown w-100 mb-sm-0 mb-3" data-bs-toggle="select">
                                <button class="btn btn-link btn-lg dropdown-toggle ps-2 ps-sm-3" type="button"
                                        ...
                                        class="dropdown-toggle-label">Todas categorias</span></button>
                                <input type="hidden">
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#"><i
                                                class="fi-bed fs-lg opacity-60 me-2"></i><span
                                                class="dropdown-item-label">Acomodação</span></a></li>
                                    <li><a class="dropdown-item" href="#"><i
                                                class="fi-cafe fs-lg opacity-60 me-2"></i><span
                                                class="dropdown-item-label">Comida &amp; Bebida</span></a></li>
                                    <li><a class="dropdown-item" href="#"><i
                                                class="fi-shopping-bag fs-lg opacity-60 me-2"></i><span
                                                class="dropdown-item-label">Compras</span></a></li>
                                    <li><a class="dropdown-item" href="#"><i
                                                class="fi-museum fs-lg opacity-60 me-2"></i><span
                                                class="dropdown-item-label">Arte &amp; História</span></a></li>
                                    <li><a class="dropdown-item" href="#"><i
                                                class="fi-entertainment fs-lg opacity-60 me-2"></i><span
                                                class="dropdown-item-label">Entreterimento</span></a></li>
                                    <li><a class="dropdown-item" href="#"><i
                                                class="fi-meds fs-lg opacity-60 me-2"></i><span
                                                class="dropdown-item-label">Farmácia</span></a></li>
                                    <li><a class="dropdown-item" href="#"><i
                                                class="fi-makeup fs-lg opacity-60 me-2"></i><span
                                                class="dropdown-item-label">Salão</span></a></li>
                                    <li><a class="dropdown-item" href="#"><i
                                                class="fi-car fs-lg opacity-60 me-2"></i><span
                                                class="dropdown-item-label">Carro aluguel</span></a></li>
                                </ul>
                            </div>
    ...
    <section class="container d-flex flex-wrap flex-column flex-sm-row pb-5 mb-md-3"><a
        ...
        <div class="dropdown mb-2 mb-sm-3"><a
                ...
                <h3 class="icon-box-title fs-sm ps-1 pe-2 mb-0">Mais</h3></a>
            <div class="dropdown-menu dropdown-menu-sm-end my-1"><a class="dropdown-item fw-bold"
                                                                    href="city-guide-catalog.html"><i
                        class="fi-meds fs-base opacity-60 me-2"></i>Farmácia</a><a class="dropdown-item fw-bold"
                                                                                   href="city-guide-catalog.html"><i
                        class="fi-makeup fs-base opacity-60 me-2"></i>Salão</a><a class="dropdown-item fw-bold"
                                                                                  href="city-guide-catalog.html"><i
                        class="fi-car fs-base opacity-60 me-2"></i>Aluguel carro</a><a class="dropdown-item fw-bold"
                                                                                       href="city-guide-catalog.html"><i
    ...
    <section class="container mb-sm-5 mb-4 pb-lg-4">
        <div class="d-sm-flex align-items-center justify-content-between mb-4 pb-2">
            <h2 class="h3 mb-sm-0">Where to stay in Berlin</h2><a class="btn btn-link fw-normal ms-sm-3 p-0"
                                                                  href="city-guide-catalog.html">Ver todos<i
                ...
                <div>
                    <div class="position-relative">
                        <div class="position-relative mb-3">
                            ...
                            <img class="rounded-3" src="{{asset('site/img/city-guide/catalog/01.jpg')}}" alt="Image">
                        </div>
                        <h3 class="mb-2 fs-lg"><a class="nav-link stretched-link" href="city-guide-single.html">Berlin
                                Business Hotel</a></h3>
                        <ul class="list-inline mb-0 fs-xs">
                            ...
                            <li class="list-inline-item pe-1"><i
                                    class="fi-map-pin mt-n1 me-1 fs-base text-muted align-middle"></i>1.4 km from center
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="position-relative">
                        <div class="position-relative mb-3">
                            <button
                                ...
                                type="button" data-bs-toggle="tooltip" data-bs-placement="left"
                                title="Add to Favorites"><i class="fi-heart"></i></button>
                            <img class="rounded-3" src="{{asset('site/img/city-guide/catalog/02.jpg')}}" alt="Image">
                        </div>
                        <h3 class="mb-2 fs-lg"><a class="nav-link stretched-link" href="city-guide-single.html">Big Tree
                                Cottage</a></h3>
                        <ul class="list-inline mb-0 fs-xs">
                            <li class="list-inline-item pe-1"><i
                            ...
                            <li class="list-inline-item pe-1"><i
                                    class="fi-map-pin mt-n1 me-1 fs-base text-muted align-middle"></i>0.5 km from center
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="position-relative">
                        <div class="position-relative mb-3">
                            <button
                                ...
                                type="button" data-bs-toggle="tooltip" data-bs-placement="left"
                                title="Add to Favorites"><i class="fi-heart"></i></button>
                            <img class="rounded-3" src="{{asset('site/img/city-guide/catalog/03.jpg')}}" alt="Image">
                        </div>
                        <h3 class="mb-2 fs-lg"><a class="nav-link stretched-link" href="city-guide-single.html">Grand
                                Resort &amp; Spa</a></h3>
                        <ul class="list-inline mb-0 fs-xs">
                            <li class="list-inline-item pe-1"><i
                            ...
                            <li class="list-inline-item pe-1"><i
                                    class="fi-map-pin mt-n1 me-1 fs-base text-muted align-middle"></i>1.8 km from center
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="position-relative">
                        <div class="position-relative mb-3">
                            <button
                                ...
                                type="button" data-bs-toggle="tooltip" data-bs-placement="left"
                                title="Add to Favorites"><i class="fi-heart"></i></button>
                            <img class="rounded-3" src="{{asset('site/img/city-guide/catalog/04.jpg')}}" alt="Image">
                        </div>
                        <h3 class="mb-2 fs-lg"><a class="nav-link stretched-link" href="city-guide-single.html">Merry
                                Berry Motel</a></h3>
                        <ul class="list-inline mb-0 fs-xs">
                            <li class="list-inline-item pe-1"><i
                            ...
                            <li class="list-inline-item pe-1"><i
                                    class="fi-map-pin mt-n1 me-1 fs-base text-muted align-middle"></i>0.4 km from center
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="container mb-5 pb-lg-4">
        <div class="row">
            <!-- Banner-->
            <div class="col-lg-4 text-center text-lg-start mb-lg-0 mb-5"><a
                    class="d-block text-decoration-none bg-faded-accent rounded-3 h-100" href="#">
                    <div class="p-4">
                        <h2 class="mb-0 p-2 text-primary text-nowrap"><i
                                class="fi-phone mt-n1 me-2 pe-1 fs-3 align-middle"></i>Taxi<span class="text-dark">&nbsp;488</span>
                        </h2>
                        <p class="mb-0 p-2 fs-lg text-body">The best way to get wherever you’re going!</p>
                    </div>
                    <img src="{{asset('site/img/city-guide/illustrations/taxi.svg')}}" alt="Illustration"></a></div>
            <!-- Where to eat-->
            <div class="col-lg-8">
                <div class="d-flex align-items-center justify-content-between mb-4 pb-2">
                    <h2 class="h3 mb-0">Where to eat</h2><a class="btn btn-link fw-normal p-0"
                                                            href="city-guide-catalog.html">Ver todos<i
                            class="fi-arrow-long-right ms-2"></i></a>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <!-- Item-->
                        <div class="d-flex align-items-start position-relative mb-4"><img
                                class="flex-shrink-0 me-3 rounded-3"
                                src="{{asset('site/img/city-guide/brands/01.svg')}}" alt="Brand logo">
                            <div>
                                <h3 class="mb-2 fs-lg"><a class="nav-link stretched-link" href="city-guide-single.html">Pina
                                        Pizza Restaurant</a></h3>
                                <ul class="list-unstyled mb-0 fs-xs">
                                    <li><i class="fi-star-filled mt-n1 me-1 fs-base text-warning align-middle"></i><b>5.0</b><span
                                            class="text-muted">&nbsp;(48)</span></li>
                                    <li><i class="fi-credit-card mt-n1 me-1 fs-base text-muted align-middle"></i>$$</li>
                                    <li><i class="fi-map-pin mt-n1 me-1 fs-base text-muted align-middle"></i>1.4 km from
                                        center
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="d-flex align-items-start position-relative mb-4"><img
                                class="flex-shrink-0 me-3 rounded-3"
                                src="{{asset('site/img/city-guide/brands/02.svg')}}" alt="Brand logo">
                            <div>
                                <h3 class="mb-2 fs-lg"><a class="nav-link stretched-link" href="city-guide-single.html">KFC</a>
                                </h3>
                                <ul class="list-unstyled mb-0 fs-xs">
                                    <li><i class="fi-star-filled mt-n1 me-1 fs-base text-warning align-middle"></i><b>4.0</b><span
                                            class="text-muted">&nbsp;(18)</span></li>
                                    <li><i class="fi-credit-card mt-n1 me-1 fs-base text-muted align-middle"></i>$</li>
                                    <li><i class="fi-map-pin mt-n1 me-1 fs-base text-muted align-middle"></i>1.8 km from
                                        center
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="d-flex align-items-start position-relative mb-4"><img
                                class="flex-shrink-0 me-3 rounded-3"
                                src="{{asset('site/img/city-guide/brands/03.svg')}}" alt="Brand logo">
                            <div>
                                <h3 class="mb-2 fs-lg"><a class="nav-link stretched-link" href="city-guide-single.html">Yum
                                        Restaurant</a></h3>
                                <ul class="list-unstyled mb-0 fs-xs">
                                    <li><i class="fi-star-filled mt-n1 me-1 fs-base text-warning align-middle"></i><b>4.6</b><span
                                            class="text-muted">&nbsp;(48)</span></li>
                                    <li><i class="fi-credit-card mt-n1 me-1 fs-base text-muted align-middle"></i>$</li>
                                    <li><i class="fi-map-pin mt-n1 me-1 fs-base text-muted align-middle"></i>2.4 km from
                                        center
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="d-flex align-items-start position-relative mb-4"><img
                                class="flex-shrink-0 me-3 rounded-3"
                                src="{{asset('site/img/city-guide/brands/04.svg')}}" alt="Brand logo">
                            <div>
                                <h3 class="mb-2 fs-lg"><a class="nav-link stretched-link" href="city-guide-single.html">Tosaka
                                        Sushi Bar</a></h3>
                                <ul class="list-unstyled mb-0 fs-xs">
                                    <li><i class="fi-star-filled mt-n1 me-1 fs-base text-warning align-middle"></i><b>5.0</b><span
                                            class="text-muted">&nbsp;(28)</span></li>
                                    <li><i class="fi-credit-card mt-n1 me-1 fs-base text-muted align-middle"></i>$$$
                                    </li>
                                    <li><i class="fi-map-pin mt-n1 me-1 fs-base text-muted align-middle"></i>2.5 km from
                                        center
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="d-flex align-items-start position-relative mb-4"><img
                                class="flex-shrink-0 me-3 rounded-3"
                                src="{{asset('site/img/city-guide/brands/05.svg')}}" alt="Brand logo">
                            <div>
                                <h3 class="mb-2 fs-lg"><a class="nav-link stretched-link" href="city-guide-single.html">Dunkin'
                                        Donuts</a></h3>
                                <ul class="list-unstyled mb-0 fs-xs">
                                    <li><i class="fi-star-filled mt-n1 me-1 fs-base text-warning align-middle"></i><b>5.0</b><span
                                            class="text-muted">&nbsp;(43)</span></li>
                        ...
                        <!-- Item-->
                        <div class="d-flex align-items-start position-relative"><img
                                class="flex-shrink-0 me-3 rounded-3"
                                src="{{asset('site/img/city-guide/brands/06.svg')}}" alt="Brand logo">
                            <div>
                                <h3 class="mb-2 fs-lg"><a class="nav-link stretched-link" href="city-guide-single.html">Spicy
                                        Bar-Restaurant</a></h3>
                                <ul class="list-unstyled mb-0 fs-xs">
                                    <li><i class="fi-star-filled mt-n1 me-1 fs-base text-warning align-middle"></i><b>5.0</b><span
                                    ...
                                    <li><i class="fi-map-pin mt-n1 me-1 fs-base text-muted align-middle"></i>0.4 km from
                                        center
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="w-100 ms-md-3 mb-n3 pt-2 pb-3 px-1" data-simplebar data-simplebar-auto-hide="false">
                <div class="d-flex align-items-center">
                    <div class="input-group input-group-sm flex-shrink-0 ms-md-auto me-3" style="max-width: 180px;">
                        <input class="form-control date-picker rounded-pill ps-5" type="text" placeholder="Choose date"
                    ...
                    <a class="btn btn-sm btn-secondary rounded-pill fw-normal ms-n1 me-3"
                       href="city-guide-catalog-filters.html">Tomorrow</a><a
                        class="btn btn-sm btn-secondary rounded-pill fw-normal ms-n1 me-3"
                        href="city-guide-catalog-filters.html">This weekend</a><a
                        class="btn btn-link ms-md-3 ms-auto p-0 fw-normal" href="city-guide-catalog-filters.html">Ver
                        todos<i class="fi-arrow-long-right ms-2"></i></a>
                </div>
            </div>
        </div>
        <!-- Carousel-->
            ...
            <div class="tns-carousel-inner"
                ...
                <div>
                    <div class="card border-0 bg-size-cover pt-5"
                         style="background-image: url(img/city-guide/home/upcoming-1.jpg);">
                            ...
                            <div class="d-md-flex justify-content-between align-items-end">
                                <div class="me-2 mb-4 mb-md-0">
                                    <div
                                        ...
                                        <div class="text-nowrap me-3"><i
                                                class="fi-calendar-alt me-1 opacity-70"></i><span class="align-middle">Nov 15</span>
                                        </div>
                                        <div class="text-nowrap"><i class="fi-clock me-1 opacity-70"></i><span
                                                class="align-middle">21:00</span></div>
                                    </div>
                                    <h3 class="h5 text-light mb-0">Simon Rock Concert</h3>
                                </div>
                                <div class="btn-group"><a class="btn btn-primary rounded-pill rounded-end-0 px-3"
                                                          href="#">Tickets from $50</a>
                                    <button
                                        class="btn btn-primary border-end-0 border-top-0 border-bottom-0 border-light rounded-pill rounded-start-0 px-3"
                ...
                <div>
                    <div class="card border-0 bg-size-cover pt-5"
                         style="background-image: url(img/city-guide/home/upcoming-2.jpg);">
                        <div class="d-none d-md-block" style="height: 13rem;"></div>
                        <div class="card-body text-center text-md-start pt-4 pt-xl-0">
                            <div class="d-md-flex justify-content-between align-items-end">
                                <div class="me-2 mb-4 mb-md-0">
                                    <div
                                        class="d-flex justify-content-center justify-content-md-start text-light fs-sm mb-2">
                                        <div class="text-nowrap me-3"><i
                                                class="fi-calendar-alt me-1 opacity-70"></i><span class="align-middle">Dec 2</span>
                                        </div>
                                        <div class="text-nowrap"><i class="fi-clock me-1 opacity-70"></i><span
                ...
                <div>
                    <div class="card border-0 bg-size-cover pt-5"
                         style="background-image: url(img/city-guide/home/upcoming-3.jpg);">
                        <div class="d-none d-md-block" style="height: 13rem;"></div>
                        <div class="card-body text-center text-md-start pt-4 pt-xl-0">
                            <div class="d-md-flex justify-content-between align-items-end">
                                <div class="me-2 mb-4 mb-md-0">
                                    <div
                                        class="d-flex justify-content-center justify-content-md-start text-light fs-sm mb-2">
                                        <div class="text-nowrap me-3"><i
                                                class="fi-calendar-alt me-1 opacity-70"></i><span class="align-middle">No 11</span>
                                        </div>
                                        <div class="text-nowrap"><i class="fi-clock me-1 opacity-70"></i><span
        ...
        <div class="tns-carousel-wrapper">
            <div class="tns-carousel-inner"
                ...
                <div>
                    <div class="row">
                        <div class="col-md-7 mb-md-0 mb-3"><img class="position-relative rounded-3 zindex-5"
                                                                src="{{asset('site/img/city-guide/home/new-1.jpg')}}"
                                                                alt="Article image"></div>
                        <div class="col-md-5">
                            <h3 class="h4 from-top">Amusement Park</h3>
                            <ul class="list-unstyled delay-2 from-end">
                                <li class="mb-1 fs-sm"><i class="fi-map-pin text-muted me-2 fs-base"></i>Ollenhauer Str.
                                    29, 10118
                                </li>
                            ...
                            <p class="pb-2 delay-3 from-end d-none d-lg-block">Blandit lorem dictum in velit. Et nisi
                                ...
                                varius. Enim non euismod adipiscing a enim.</p><a
                                class="btn btn-primary rounded-pill delay-4 scale-up" href="city-guide-single.html">View
                                more<i class="fi-chevron-right fs-sm ms-2"></i></a>
                        </div>
                    </div>
                </div>
                <!-- Item-->
                <div>
                    <div class="row">
                        <div class="col-md-7 mb-md-0 mb-3"><img class="position-relative rounded-3 zindex-5"
                                                                src="{{asset('site/img/city-guide/home/new-2.jpg')}}"
                                                                alt="Article image"></div>
                        <div class="col-md-5">
                            ...
                            <ul class="list-unstyled delay-2 from-end">
                                ...
                                <li class="mb-1 fs-sm"><i class="fi-clock text-muted me-2 fs-base"></i>10:00 – 20:00
                                </li>
                                <li class="mb-1 fs-sm"><i class="fi-wallet text-muted me-2 fs-base"></i>$$</li>
                            </ul>
                            <p class="pb-2 delay-3 from-end d-none d-lg-block">Sem nibh urna id arcu. Quis tortor
                                ...
                                dictum nunc varius.</p><a class="btn btn-primary rounded-pill delay-4 scale-up"
                                                          href="city-guide-single.html">View more<i
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6 ps-lg-5">
                    <div class="ps-xl-5 pe-md-0 pt-4 pb-md-4 px-3 text-center text-md-start">
                        ...
                        <div class="d-flex flex-column flex-sm-row justify-content-center justify-content-md-start"><a
                                class="btn-market me-sm-3 mb-3" href="#" role="button">
                            ...
                            </a><a class="btn-market mb-3" href="#" role="button">
                ...
                <div class="col-lg-7 col-md-6"><img class="d-none d-md-block"
                                                    src="{{asset('site/img/city-guide/illustrations/app.png')}}"
                                                    width="698" alt="Illustration"><img
                        class="d-block d-md-none mx-auto" src="{{asset('site/img/city-guide/illustrations/app-m.png')}}"
                        width="446" alt="Illustration"></div>
            </div>
        </div>
    </section>
    <!-- Blog: Latest posts-->
    <section class="container my-5 py-lg-4">
        <div class="d-sm-flex align-items-center justify-content-between mb-4 pb-2">
            <h2 class="h3 mb-sm-0">You may be also interested in</h2><a class="btn btn-link fw-normal ms-sm-3 p-0"
                                                                        href="city-guide-blog.html">Go to blog<i
                    class="fi-arrow-long-right ms-2"></i></a>
        </div>
        <!-- Carousel-->
        <div class="tns-carousel-wrapper tns-nav-outside mb-md-2">
            <div class="tns-carousel-inner d-block"
                ...
                <!-- Item-->
                <article><a class="d-block mb-3" href="city-guide-blog-single.html"><img class="rounded-3"
                                                                                         src="{{asset('site/img/city-guide/blog/01.jpg')}}"
                                                                                         alt="Post image"></a><a
                        class="fs-xs text-uppercase text-decoration-none" href="#">Travelling</a>
                    <h3 class="fs-base pt-1"><a class="nav-link" href="city-guide-blog-single.html">Air Travel in the
                            Time of COVID-19</a></h3><a class="d-flex align-items-center text-decoration-none" href="#"><img
                            class="rounded-circle" src="{{asset('site/img/avatars/16.png')}}" width="44" alt="Avatar">
                        <div class="ps-2">
                            <h6 class="fs-sm text-nav lh-base mb-1">Bessie Cooper</h6>
                            <div class="d-flex text-body fs-xs"><span class="me-2 pe-1"><i
                                        class="fi-calendar-alt opacity-70 mt-n1 me-1 align-middle"></i>May 24</span><span><i
                                        class="fi-chat-circle opacity-70 mt-n1 me-1 align-middle"></i>No comments</span>
                            </div>
                        </div>
                    </a>
                </article>
                <!-- Item-->
                <article><a class="d-block mb-3" href="city-guide-blog-single.html"><img class="rounded-3"
                                                                                         src="{{asset('site/img/city-guide/blog/02.jpg')}}"
                                                                                         alt="Post image"></a><a
                        class="fs-xs text-uppercase text-decoration-none" href="#">Entertainment</a>
                    <h3 class="fs-base pt-1"><a class="nav-link" href="city-guide-blog-single.html">10 World-Class
                            Museums You Can Visit Online</a></h3><a
                        class="d-flex align-items-center text-decoration-none" href="#"><img class="rounded-circle"
                                                                                             src="{{asset('site/img/avatars/18.png')}}"
                                                                                             width="44" alt="Avatar">
                        <div class="ps-2">
                            <h6 class="fs-sm text-nav lh-base mb-1">Annette Black</h6>
                            <div class="d-flex text-body fs-xs"><span class="me-2 pe-1"><i
                                        class="fi-calendar-alt opacity-70 mt-n1 me-1 align-middle"></i>Apr 28</span><span><i
                                        class="fi-chat-circle opacity-70 mt-n1 me-1 align-middle"></i>4 comments</span>
                            </div>
                        </div>
                    </a>
                </article>
                <!-- Item-->
                <article><a class="d-block mb-3" href="city-guide-blog-single.html"><img class="rounded-3"
                                                                                         src="{{asset('site/img/city-guide/blog/03.jpg')}}"
                                                                                         alt="Post image"></a><a
                        class="fs-xs text-uppercase text-decoration-none" href="#">Travelling</a>
                    <h3 class="fs-base pt-1"><a class="nav-link" href="city-guide-blog-single.html">7 Tips for Solo
                            Travelers in Africa</a></h3><a class="d-flex align-items-center text-decoration-none"
                                                           href="#"><img class="rounded-circle"
                                                                         src="{{asset('site/img/avatars/17.png')}}"
                                                                         width="44" alt="Avatar">
                        <div class="ps-2">
                            <h6 class="fs-sm text-nav lh-base mb-1">Ralph Edwards</h6>
                            <div class="d-flex text-body fs-xs"><span class="me-2 pe-1"><i
                                        class="fi-calendar-alt opacity-70 mt-n1 me-1 align-middle"></i>Apr 15</span><span><i
                                        class="fi-chat-circle opacity-70 mt-n1 me-1 align-middle"></i>2 comments</span>
                            </div>
                        </div>
                    </a>
                </article>
        ...
        <div class="row gy-4">
            <div class="col-lg-3 col-md-6 col-sm-4">
                <div class="mb-4 pb-sm-3"><a class="d-inline-block" href="city-guide-home-v1.html"><img
                            src="{{asset('site/img/logo/logo-light.svg')}}" width="116" alt="Logo"></a></div>
                <ul class="nav nav-light flex-column">
                    <li class="nav-item mb-2"><a class="nav-link p-0 fw-normal text-light text-nowrap"
                                                 href="mailto:example@gmail.com"><i
                                class="fi-mail mt-n1 me-1 align-middle text-primary"></i>example@gmail.com</a></li>
                    <li class="nav-item mb-2"><a class="nav-link p-0 fw-normal text-light text-nowrap"
                                                 href="tel:4065550120"><i
                                class="fi-device-mobile mt-n1 me-1 align-middle text-primary"></i>(406) 555-0120</a>
                    </li>
                </ul>
            </div>
            <!-- Links-->
    ...
    <div class="py-4 border-top border-light">
        <div class="container d-flex flex-column flex-lg-row align-items-center justify-content-between py-2">
            ...
            <div class="d-flex flex-lg-row flex-column align-items-center order-lg-2 order-1 ms-lg-4 mb-lg-0 mb-4">
                <!-- Links-->
                <div class="d-flex flex-wrap fs-sm mb-lg-0 mb-4 pe-lg-4"><a class="nav-link-light px-2 mx-1" href="#">About</a><a
                        class="nav-link-light px-2 mx-1" href="#">Blog</a><a class="nav-link-light px-2 mx-1" href="#">Support</a><a
                        class="nav-link-light px-2 mx-1" href="#">Contacts</a></div>
                <div class="d-flex align-items-center">
                    <!-- Language switcher-->
                    <div class="dropdown"><a
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark my-1" aria-labelledby="langSwitcher">
                            <li><a class="dropdown-item text-nowrap py-1" href="#"><img class="me-2"
                                                                                        src="{{asset('site/img/flags/de.png')}}"
                                                                                        width="20" alt="Deutsch">Deutsch</a>
                            </li>
                            <li><a class="dropdown-item text-nowrap py-1" href="#"><img class="me-2"
                                                                                        src="{{asset('site/img/flags/fr.png')}}"
                                                                                        width="20" alt="Français">Français</a>
                            </li>
                            <li><a class="dropdown-item text-nowrap py-1" href="#"><img class="me-2"
                                                                                        src="{{asset('site/img/flags/es.png')}}"
                                                                                        width="20" alt="Español">Español</a>
                            </li>
                        </ul>
                    </div>
                    <!-- Socials-->
...
<script src="{{asset('site/vendor/simplebar/dist/simplebar.min.js')}}"></script>
<script src="{{asset('site/vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js')}}"></script>
<script src="{{asset('site/vendor/tiny-slider/dist/min/tiny-slider.js')}}"></script>
<script src="{{asset('site/vendor/flatpickr/dist/flatpickr.min.js')}}"></script>
<!-- Main theme script-->
<script src="{{asset('site/js/theme.min.js')}}"></script>
</body>
</html>
